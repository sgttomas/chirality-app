...
This guidance document supports the development of **Instrumentation Technical Specification** for **PKG-20 Field Instrumentation**.

Defines performance, materials, and workmanship requirements for instrumentation per ER requirements.

This deliverable is classified as a **Specification** under the **I&C** discipline, to be produced by **D&B Contractor**.
...
- Level instrument specification
- pressure instrument specification
