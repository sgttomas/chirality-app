...
This guidance document supports the development of **Instrumentation Design Drawing Set** for **PKG-20 Field Instrumentation**.

Defines the design arrangement and details for instrumentation per ER requirements.

This deliverable is classified as a **Drawing** under the **I&C** discipline, to be produced by **D&B Contractor**.
