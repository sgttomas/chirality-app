# Guidance: DEL-21.02 Building Technical Specification

## Purpose

This guidance document supports the development of **Building Technical Specification** for **PKG-21 Building Structures & Envelope**.

Defines performance, materials, and workmanship requirements for building per ER requirements.

This deliverable is classified as a **Specification** under the **Buildings** discipline, to be produced by **D&B Contractor**.
