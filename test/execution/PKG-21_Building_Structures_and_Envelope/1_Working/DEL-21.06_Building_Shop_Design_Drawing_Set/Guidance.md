# Guidance: DEL-21.06 Building Shop Design Drawing Set

## Purpose

This guidance document supports the development of **Building Shop Design Drawing Set** for **PKG-21 Building Structures & Envelope**.

Defines and substantiates building shop in accordance with ER requirements.

This deliverable is classified as a **Drawing Set** under the **Buildings** discipline, to be produced by **D&B Contractor**.

## Principles

**Engineering rationale (Buildings discipline):**
...
- Package scope: PKG-21 Building Structures & Envelope
- Deliverable type: Drawing Set — consider type-specific requirements and conventions
...
- Fabrication/shop drawings for modular building
- envelope details
