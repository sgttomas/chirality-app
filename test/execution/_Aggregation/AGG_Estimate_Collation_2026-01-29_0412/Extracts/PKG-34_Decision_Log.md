# Decision Log — PKG-34 Coordination & Interfaces Estimate
...
**Impacted WBS/CBS:** All packages (PKG-00 through PKG-35). This estimate covers PKG-34 only.

**Estimate Impact:** This estimate is a subset of the full project. Indirects, project management, and other cross-package costs are allocated proportionally to PKG-34.
...
**Estimate Impact:** All costs expressed in CAD. No currency conversion required for Canadian coordination service providers.
...
**Trigger:** Source discovery (Phase 2.2) found no vendor quotes, budgetary proposals, or project rate tables for coordination and interface management services.

**Evidence:**
- No interface coordination service provider quotes available
- No trenchless monitoring quotes available
- `_Estimates/_RateTables/` directory does not contain coordination or monitoring rates
- No pricing documents discovered in PKG-34 deliverable folders
...
1. Obtain budgetary quotes from coordination service providers
2. Obtain quotes from survey/monitoring providers for trenchless crossings
3. Add coordination rate tables to `_Estimates/_RateTables/` directory
...
**Trigger:** No detailed construction schedule or coordination duration data discovered in deliverable documents.

**Evidence:** Decomposition specifies coordination and interface scope but does not provide detailed construction schedule or coordination effort durations.

**Impacted WBS/CBS:** Construction Indirects (CI), Project Management (PM), Procurement (P).

**Estimate Impact:** Indirects calculated as factors using fallback typical model defaults.

**Override Path:** Provide detailed construction schedule to enable time-based indirects calculation.
...
## D-010: Construction Duration Assumption — 24-30 Months

**Decision:** Assume construction duration of 24-30 months for time-based coordination effort calculations.

**Trigger:** Construction schedule not explicitly defined in decomposition; typical design-build duration applied.

**Evidence:**
- Project is a multi-phase industrial terminal facility
- Typical D&B construction durations for similar scope: 24-36 months
- Conservative mid-range assumption: 24-30 months

**Impacted WBS/CBS:** PM — coordination meeting count, security compliance duration

**Estimate Impact:** Coordination effort sized based on ~100-130 weekly meetings and 24-30 month compliance period.

**Override Path:** Clarify construction schedule with Employer; adjust coordination effort duration as needed.
...
|-------------|-------|-----------|------------|--------------|
| D-001 | Scope | PKG-34 only | HIGH | HIGH |
...
| D-010 | Duration | 24-30 months | MED | MED |
