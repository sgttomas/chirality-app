# Procedure: DEL-31.06 Asset Hierarchy

## Purpose

This procedure defines the process for producing and managing **Asset Hierarchy** within **PKG-31 Documentation & Deliverables**.
