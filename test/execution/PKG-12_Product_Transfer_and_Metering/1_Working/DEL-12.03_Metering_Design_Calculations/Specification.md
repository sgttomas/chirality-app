...
This specification defines the requirements for **Metering Design Calculations** within **PKG-12 Product Transfer & Metering**.

Provides the engineering basis and sizing/verification calculations for metering.
