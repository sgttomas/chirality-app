...
This procedure defines the process for producing and managing **Metering Data Sheet Package** within **PKG-12 Product Transfer & Metering**.

Defines and substantiates metering in accordance with ER requirements.
...
- Flow meter data sheets (2)
- temperature/pressure transmitter data sheets
