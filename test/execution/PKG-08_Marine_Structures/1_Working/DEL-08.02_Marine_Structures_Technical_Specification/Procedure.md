...
This procedure defines the process for producing and managing **Marine Structures Technical Specification** within **PKG-08 Marine Structures**.

Defines performance, materials, and workmanship requirements for marine structures per ER requirements.
