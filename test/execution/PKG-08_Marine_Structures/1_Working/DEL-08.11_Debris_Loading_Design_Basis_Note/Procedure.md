...
This procedure defines the process for producing and managing **Debris Loading Design Basis Note** within **PKG-08 Marine Structures**.

Provides project management/control documentation for debris loading design basis note required by the ERs.
...
- Debris loading basis of design
- assumptions
- load cases
