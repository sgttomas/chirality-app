...
This procedure defines the process for producing and managing **Marine Structures Design Drawing Set** within **PKG-08 Marine Structures**.

Defines the design arrangement and details for marine structures per ER requirements.
