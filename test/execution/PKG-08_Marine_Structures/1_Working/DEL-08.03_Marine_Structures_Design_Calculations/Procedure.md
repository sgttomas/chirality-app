...
This procedure defines the process for producing and managing **Marine Structures Design Calculations** within **PKG-08 Marine Structures**.

Provides the engineering basis and sizing/verification calculations for marine structures.
