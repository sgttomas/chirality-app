# Procedure: DEL-07.02 Rail Works Technical Specification

## Purpose

This procedure defines the process for producing and managing **Rail Works Technical Specification** within **PKG-07 Rail Works**.

Defines performance, materials, and workmanship requirements for rail works per ER requirements.
...
- track construction specification
