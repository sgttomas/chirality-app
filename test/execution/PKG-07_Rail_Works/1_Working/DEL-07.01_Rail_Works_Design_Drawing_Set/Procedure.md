...
This procedure defines the process for producing and managing **Rail Works Design Drawing Set** within **PKG-07 Rail Works**.

Defines the design arrangement and details for rail works per ER requirements.
