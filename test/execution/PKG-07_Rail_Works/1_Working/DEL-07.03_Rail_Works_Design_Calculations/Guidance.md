...
This guidance document supports the development of **Rail Works Design Calculations** for **PKG-07 Rail Works**.

Provides the engineering basis and sizing/verification calculations for rail works.

This deliverable is classified as a **Calculation** under the **Structural** discipline, to be produced by **D&B Contractor**.
