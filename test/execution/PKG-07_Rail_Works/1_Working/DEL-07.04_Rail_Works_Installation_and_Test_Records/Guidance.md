# Guidance: DEL-07.04 Rail Works Installation & Test Records

## Purpose

This guidance document supports the development of **Rail Works Installation & Test Records** for **PKG-07 Rail Works**.

Provides evidence of completion, inspection, and testing for rail works.

This deliverable is classified as a **Record** under the **Structural** discipline, to be produced by **D&B Contractor (QA/QC)**.

## Principles

**Engineering rationale (Structural discipline):**
...
- Package scope: PKG-07 Rail Works
...
- Track alignment survey
- ballast test records
- rail weld inspection records
