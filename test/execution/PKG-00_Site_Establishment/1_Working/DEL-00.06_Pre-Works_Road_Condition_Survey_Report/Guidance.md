# Guidance: DEL-00.06 Pre-Works Road Condition Survey Report

## Purpose

This guidance document supports the development of **Pre-Works Road Condition Survey Report** for **PKG-00 Site Establishment**.

Documents analysis and results for pre-works road condition survey report required for design verification and approvals.

This deliverable is classified as a **Report** under the **General** discipline, to be produced by **D&B Contractor (Surveyor)**.
