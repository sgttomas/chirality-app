# Procedure: DEL-00.05 Road Access Configuration & Security Process Submission

## Purpose

This procedure defines the process for producing and managing **Road Access Configuration & Security Process Submission** within **PKG-00 Site Establishment**.
