...
This guidance document supports the development of **Commissioning Plan** for **PKG-30 Commissioning**.

Defines the planned approach and controls for commissioning plan to meet ER requirements.

This deliverable is classified as a **Plan** under the **T&C** discipline, to be produced by **D&B Contractor (Commissioning Team)**.
