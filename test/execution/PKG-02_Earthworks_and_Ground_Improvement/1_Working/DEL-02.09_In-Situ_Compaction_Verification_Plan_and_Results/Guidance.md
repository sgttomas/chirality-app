...
This guidance document supports the development of **In-Situ Compaction Verification Plan & Results** for **PKG-02 Earthworks & Ground Improvement**.

Provides evidence of completion, inspection, and testing for in-situ compaction verification plan & results.

This deliverable is classified as a **Record** under the **Civil** discipline, to be produced by **D&B Contractor**.
...
- Package scope: PKG-02 Earthworks & Ground Improvement
...
- Compaction verification plan
- test results
- nonconformance reports and closeout
