# Specification: DEL-02.09 In-Situ Compaction Verification Plan & Results

    ## Scope

    This deliverable defines the requirements for In-Situ Compaction Verification Plan & Results within PKG-02 Earthworks & Ground Improvement. Source: _CONTEXT.md; decomposition DEL-02 entry (location TBD).
...
- R6: Document control fields (title, revision, dates, approvals) shall be included. Source: ASSUMPTION: standard D&B document control; details TBD.
    ...
    - Controlled In-Situ Compaction Verification Plan & Results deliverable (issued revision).
