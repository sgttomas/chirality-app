# Datasheet: DEL-02.09 In-Situ Compaction Verification Plan & Results
    ...
    | Name | In-Situ Compaction Verification Plan & Results |
    ...
    | Attribute | Value |
    |-----------|-------|
    | Record package ID | **TBD** |
| Date range | **TBD** |
| Location / area | **TBD** |
| Testing / inspection method | **TBD** |
| QA/QC signoff | **TBD** |
| Revision | **TBD** |
    ...
    - Deliverable intent: Provides evidence of completion, inspection, and testing for in-situ compaction verification plan & results. Source: _CONTEXT.md; decomposition DEL-02 entries (location TBD).
