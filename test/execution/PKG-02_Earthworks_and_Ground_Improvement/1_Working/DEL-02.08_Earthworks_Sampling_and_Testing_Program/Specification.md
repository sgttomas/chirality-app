# Specification: DEL-02.08 Earthworks Sampling & Testing Program

    ## Scope

    This deliverable defines the requirements for Earthworks Sampling & Testing Program within PKG-02 Earthworks & Ground Improvement. Source: _CONTEXT.md; decomposition DEL-02 entry (location TBD).
...
- R7: Document control fields (title, revision, dates, approvals) shall be included. Source: ASSUMPTION: standard D&B document control; details TBD.
    ...
    - Controlled Earthworks Sampling & Testing Program deliverable (issued revision).
