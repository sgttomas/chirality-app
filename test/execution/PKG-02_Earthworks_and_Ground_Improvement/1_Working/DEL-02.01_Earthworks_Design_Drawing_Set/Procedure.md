# Procedure: DEL-02.01 Earthworks Design Drawing Set
    ...
    Produce the Earthworks Design Drawing Set required for PKG-02 Earthworks & Ground Improvement while satisfying Specification requirements and supporting Guidance principles. Source: _CONTEXT.md; decomposition (location TBD).
...
5. Issue controlled deliverable per document control requirements and capture review/approval records. ASSUMPTION: standard D&B document control.
    ...
    - Issued Earthworks Design Drawing Set (controlled revisions).
