# Specification: DEL-02.03 Earthworks Design Calculations

    ## Scope

    This deliverable defines the requirements for Earthworks Design Calculations within PKG-02 Earthworks & Ground Improvement. Source: _CONTEXT.md; decomposition DEL-02 entry (location TBD).
    ...
    - R1: Provides the engineering basis and sizing/verification calculations for earthworks. Source: decomposition DEL-02 entry and _CONTEXT.md (location TBD).
- R2: Include Cut/fill quantity calculations. Source: _CONTEXT.md.
- R3: Include bearing capacity calculations. Source: _CONTEXT.md.
- R4: Address grading, excavation, fill placement, ground improvement, geotechnical and survey scope for PKG-02. Source: decomposition PKG-02 scope (location TBD).
- R5: Document control fields (title, revision, dates, approvals) shall be included. Source: ASSUMPTION: standard D&B document control; details TBD.
    ...
    - Controlled Earthworks Design Calculations deliverable (issued revision).
