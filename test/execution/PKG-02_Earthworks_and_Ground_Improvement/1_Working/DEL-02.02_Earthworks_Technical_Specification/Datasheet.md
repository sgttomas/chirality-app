# Datasheet: DEL-02.02 Earthworks Technical Specification
    ...
    | Name | Earthworks Technical Specification |
...
| Approval status | **TBD** |
    ...
    - Deliverable intent: Defines performance, materials, and workmanship requirements for earthworks per ER requirements. Source: _CONTEXT.md; decomposition DEL-02 entries (location TBD).
