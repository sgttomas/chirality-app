# Specification: DEL-02.02 Earthworks Technical Specification

    ## Scope

    This deliverable defines the requirements for Earthworks Technical Specification within PKG-02 Earthworks & Ground Improvement. Source: _CONTEXT.md; decomposition DEL-02 entry (location TBD).
    ...
    - R1: Defines performance, materials, and workmanship requirements for earthworks per ER requirements. Source: decomposition DEL-02 entry and _CONTEXT.md (location TBD).
- R2: Include Earthworks specification. Source: _CONTEXT.md.
- R3: Include ground improvement specification. Source: _CONTEXT.md.
- R4: Include geotextile specification. Source: _CONTEXT.md.
...
- R6: Document control fields (title, revision, dates, approvals) shall be included. Source: ASSUMPTION: standard D&B document control; details TBD.
    ...
    - Controlled Earthworks Technical Specification deliverable (issued revision).
