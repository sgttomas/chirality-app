# Specification: DEL-02.07 Earthworks Excavation & Fill Placement Method Statement

    ## Scope

    This deliverable defines the requirements for Earthworks Excavation & Fill Placement Method Statement within PKG-02 Earthworks & Ground Improvement. Source: _CONTEXT.md; decomposition DEL-02 entry (location TBD).
    ...
    - R1: Defines the execution method and controls for earthworks excavation & fill placement method statement to meet safety, quality, and operational requirements. Source: decomposition DEL-02 entry and _CONTEXT.md (location TBD).
- R2: Include Excavation method statement. Source: _CONTEXT.md.
- R3: Include fill placement and lift thickness procedure. Source: _CONTEXT.md.
- R4: Include material handling procedure. Source: _CONTEXT.md.
...
- R6: Document control fields (title, revision, dates, approvals) shall be included. Source: ASSUMPTION: standard D&B document control; details TBD.
    ...
    - Controlled Earthworks Excavation & Fill Placement Method Statement deliverable (issued revision).
