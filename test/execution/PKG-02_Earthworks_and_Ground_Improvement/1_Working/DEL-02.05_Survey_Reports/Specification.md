# Specification: DEL-02.05 Survey Reports
    ...
    - R1: Documents analysis and results for survey reports required for design verification and approvals. Source: decomposition DEL-02 entry and _CONTEXT.md (location TBD).
- R2: Include Topographic survey. Source: _CONTEXT.md.
- R3: Include utility locate report. Source: _CONTEXT.md.
