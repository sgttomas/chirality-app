...
This procedure defines the process for producing and managing **Underground Utilities Design Drawing Set** within **PKG-03 Underground Utilities & Drainage**.

Defines the design arrangement and details for underground utilities per ER requirements.
