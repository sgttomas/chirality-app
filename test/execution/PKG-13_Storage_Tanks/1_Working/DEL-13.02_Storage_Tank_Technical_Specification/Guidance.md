...
This guidance document supports the development of **Storage Tank Technical Specification** for **PKG-13 Storage Tanks**.

Defines performance, materials, and workmanship requirements for storage tank per ER requirements.

This deliverable is classified as a **Specification** under the **Mechanical** discipline, to be produced by **D&B Contractor**.
...
- API 650 tank specification
- agitator specification
- tank appurtenance specification
