...
This guidance document supports the development of **Storage Tank Design Calculations** for **PKG-13 Storage Tanks**.

Provides the engineering basis and sizing/verification calculations for storage tank.

This deliverable is classified as a **Calculation** under the **Mechanical** discipline, to be produced by **D&B Contractor**.
...
- Package scope: PKG-13 Storage Tanks
...
- API 650 tank design calculations (3)
