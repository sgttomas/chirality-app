# Guidance: DEL-34.05 Trenchless Crossing Monitoring Reports

## Purpose

This guidance document supports the development of **Trenchless Crossing Monitoring Reports** for **PKG-34 Coordination & Interfaces**.

Documents analysis and results for trenchless crossing monitoring reports required for design verification and approvals.

This deliverable is classified as a **Report** under the **Project Delivery** discipline, to be produced by **D&B Contractor**.
