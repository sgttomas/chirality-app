...
This procedure defines the process for producing and managing **Marine Outfitting Design Drawing Set** within **PKG-09 Marine Outfitting**.

Defines the design arrangement and details for marine outfitting per ER requirements.
