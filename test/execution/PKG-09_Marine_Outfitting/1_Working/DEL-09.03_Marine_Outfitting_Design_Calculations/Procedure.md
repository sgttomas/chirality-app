...
This procedure defines the process for producing and managing **Marine Outfitting Design Calculations** within **PKG-09 Marine Outfitting**.

Provides the engineering basis and sizing/verification calculations for marine outfitting.
