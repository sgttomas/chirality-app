# Procedure: DEL-14.07 Transient Analysis Study Report – Marine Loading Line

## Purpose

Procedure for conducting transient analysis of marine loading export line piping system to verify surge pressures within design limits (scope: Specification.md Scope; attributes: Datasheet.md Report Type; rationale: Guidance.md Purpose).
...
- Marine loading arm data from PKG-11 (configuration, ESD valve types, actuation methods, typical closing times) (construction: Datasheet.md Construction items 1, 3 - Boundary conditions, Loading arm ESD valve closing time; requirements: Specification.md FR-4, FR-9; interface: Specification.md IR-5, IR-6; rationale: Guidance.md Considerations - Operational Considerations, Ship Disconnect Scenario; Step 1, Step 4 below; verification: Specification.md Verification - Model verification, Mitigation verification; examples: Guidance.md Examples items 1, 3; cross-reference PKG-11, DEL-14.08)
...
- Operational scenarios **TBD** (normal and emergency operating procedures, including ship disconnect sequence) (conditions: Datasheet.md Transient Scenarios; requirements: Specification.md FR-5; rationale: Guidance.md Considerations - Ship Disconnect Scenario; Step 2 below)
...
**Objective:** Create transient analysis model of marine loading export line piping system (construction: Datasheet.md Construction item 1; requirements: Specification.md FR-1, FR-2, FR-3, FR-4; rationale: Guidance.md Principles item 4; quality: Specification.md QR-1; examples: Guidance.md Examples item 1).

**Actions:**
1. Input piping geometry from DEL-14.01 drawings:
   - Pipe segments (lengths, diameters, wall thicknesses, elevations from tank farm to berth) (construction: Datasheet.md Construction item 1 - Piping geometry; requirements: Specification.md FR-2; interface: Specification.md IR-1; rationale: Guidance.md Considerations - System Characteristics, Pipeline Routing; verification: Specification.md Verification - Model verification; examples: Guidance.md Examples item 1; cross-reference DEL-14.01, PKG-11)
...
3. Define boundary conditions:
   ...
   - Storage tanks: Input tank levels (normal operating level), tank pressure (atmospheric or blanketed), nozzle elevations (construction: Datasheet.md Construction item 1 - Boundary conditions; requirements: Specification.md FR-4; interface: Specification.md IR-4; rationale: Guidance.md Considerations - Operational Considerations; verification: Specification.md Verification - Model verification; examples: Guidance.md Examples item 1; cross-reference PKG-13)
   - Marine loading arms: Input loading arm configuration, ESD valve locations, sizes, types, actuation methods, typical closing times (construction: Datasheet.md Construction item 1 - Boundary conditions; requirements: Specification.md FR-4; interface: Specification.md IR-5; rationale: Guidance.md Principles item 3, Considerations - Ship Disconnect Scenario; examples: Guidance.md Examples item 1; cross-reference PKG-11)
4. Verify model completeness and accuracy (geometry check against drawings, fluid properties reasonable, boundary conditions match equipment data) (requirements: Specification.md FR-2, FR-3, FR-4; performance: Specification.md PR-5; quality: Specification.md QR-1; verification: Specification.md Verification - Model verification; verification table)

**Verification:** Model geometry matches DEL-14.01 drawings; fluid properties within expected range for canola oil; boundary conditions match equipment data (requirements: Specification.md FR-2, FR-3, FR-4; performance: Specification.md PR-5; quality: Specification.md QR-1; verification: Specification.md Verification - Model verification; verification table).
...
1. Define transient scenarios to analyze:
   ...
   - Loading arm ESD valve closing — normal and emergency rates (conditions: Datasheet.md Transient Scenarios; requirements: Specification.md FR-5; interface: Specification.md IR-5; rationale: Guidance.md Principles item 2; considerations: Guidance.md Considerations - Ship Disconnect Scenario; trade-offs: Guidance.md Trade-offs item 1; examples: Guidance.md Examples item 2, Guidance.md Considerations - Ship Disconnect; cross-reference PKG-11)
   - Ship disconnect sequence (loading arm retraction, ESD valve closure) (conditions: Datasheet.md Transient Scenarios; requirements: Specification.md FR-5; rationale: Guidance.md Principles item 2; considerations: Guidance.md Considerations - Ship Disconnect Scenario; examples: Guidance.md Considerations - Ship Disconnect, Guidance.md Examples; cross-reference PKG-11)
   - Operational upsets **TBD** (specific upset scenarios per operational philosophy, including operational flexibility modes per OBJ-4) (conditions: Datasheet.md Transient Scenarios; requirements: Specification.md FR-5; rationale: Guidance.md Considerations - Operational Flexibility; prerequisites above)
...
3. Generate pressure vs. time plots at critical locations (pump discharge, high points, loading arm, tank connections) (construction: Datasheet.md Construction item 2 - Pressure vs. time plots; requirements: Specification.md FR-6; rationale: Guidance.md Principles item 4; considerations: Guidance.md Considerations - System Characteristics, Pipeline Routing; documentation: Specification.md Documentation - Report content; examples: Guidance.md Examples item 2, Guidance.md Considerations - High/low points)
...
4. Identify scenarios where surge pressures exceed acceptable limits (construction: Datasheet.md Construction item 2 - Identification; requirements: Specification.md FR-8; performance: PR-1, PR-2; quality: Specification.md QR-3; verification: Specification.md Verification - Acceptance; verification table; examples: Guidance.md Examples item 2, Guidance.md Examples - Evaluation)
5. Perform sensitivity analysis on critical parameters (loading arm ESD valve closing time, pump inertia) (quality: Specification.md QR-2; interface: Specification.md IR-6; considerations: Guidance.md Considerations - Operational Considerations, Ship Disconnect Scenario; trade-offs: Guidance.md Trade-offs item 1; verification: Specification.md Verification - Sensitivity analysis; verification table; cross-reference PKG-11, PKG-15, DEL-14.08)
...
1. Evaluate mitigation options for each unacceptable scenario:
   - **Surge relief valves:** Specify location (pump discharge and/or berth), sizing, set pressure (construction: Datasheet.md Construction item 3 - Surge relief valves; requirements: Specification.md FR-9, FR-10; rationale: Guidance.md Principles item 3; considerations: Guidance.md Considerations - Ship Disconnect Scenario; trade-offs: Guidance.md Trade-offs items 2, 3; verification: Specification.md Verification - Mitigation verification; examples: Guidance.md Examples item 3, Guidance.md Examples - Mitigation Solution; cross-reference PKG-11, PKG-16)
   - **Loading arm ESD valve closing time limits:** Specify minimum closing time to control surge (construction: Datasheet.md Construction item 3 - Loading arm ESD valve closing time; requirements: Specification.md FR-9, FR-10; interface: Specification.md IR-6; rationale: Guidance.md Principles item 3; considerations: Guidance.md Considerations - Operational Considerations, Ship Disconnect Scenario; trade-offs: Guidance.md Trade-offs item 1; verification: Specification.md Verification - Mitigation verification; examples: Guidance.md Examples item 3, Guidance.md Examples - ESD valve closing time; cross-reference DEL-14.08, PKG-11)
   - **Accumulators or surge tanks:** Specify size, location, pressure (construction: Datasheet.md Construction item 3 - Accumulators; requirements: Specification.md FR-9; rationale: Guidance.md Principles item 3; considerations: Guidance.md Considerations - System Characteristics; trade-offs: Guidance.md Trade-offs item 3; examples: Guidance.md Examples item 3)
...
2. Select preferred mitigation approach based on lifecycle cost, reliability, operational safety, and feasibility (source: OBJ-1, OBJ-9; requirements: Specification.md FR-9; rationale: Guidance.md Principles item 3; considerations: Guidance.md Considerations - Ship Disconnect Scenario; trade-offs: Guidance.md Trade-offs items 1-4; examples: Guidance.md Examples item 3 - Recommendation; cross-reference PKG-11)
...
4. Document mitigation recommendations with implementation details (equipment specifications, locations, installation requirements, operational procedures) (construction: Datasheet.md Construction item 3; requirements: Specification.md FR-10; documentation: Specification.md Documentation - Report content; examples: Guidance.md Examples item 3; cross-reference DEL-14.01, PKG-11, DEL-14.08)

**Outputs:**
- Mitigation recommendations with implementation details (construction: Datasheet.md Construction item 3; requirements: Specification.md FR-9, FR-10; interface: Specification.md IR-6; verification: Specification.md Verification - Mitigation verification; documentation: Specification.md Documentation - Report content; records: Records section; cross-reference DEL-14.08)
...
**Actions:**
1. Compile report sections (same structure as Step 5 in parallel deliverable DEL-14.06):
   - Executive summary
   - System description (marine loading export line from tanks to berth) (attributes: Datasheet.md System Analyzed; conditions: Datasheet.md System Description)
   - Analysis methodology (rationale: Guidance.md Principles items 1, 2, 4)
   - Transient model description and validation (construction: Datasheet.md Construction items 1, 4; verification: Specification.md Verification - Model verification)
   - Transient scenarios analyzed (including ship disconnect scenario) (conditions: Datasheet.md Transient Scenarios; rationale: Guidance.md Considerations - Ship Disconnect Scenario)
   - Results (pressure plots, maximum surge pressures, comparison to limits) (construction: Datasheet.md Construction items 2, 4; verification: Specification.md Verification - Results validation; examples: Guidance.md Examples item 2)
   - Mitigation recommendations and implementation (construction: Datasheet.md Construction items 3, 4; verification: Specification.md Verification - Mitigation verification; examples: Guidance.md Examples item 3)
   - Conclusions and design verification statement (verification: Specification.md Verification - Acceptance)
...
**Actions:**
1. Assign independent reviewer (qualified piping or process engineer with transient analysis experience) (personnel: Prerequisites section; quality: Specification.md QR-4; verification: Specification.md Verification - Independent review; verification table)
2. Reviewer verifies (same verification approach as DEL-14.06; rationale: Guidance.md Principles items 1-4; quality: Specification.md QR-1, QR-2, QR-3):
   - Model inputs correct (verification: Specification.md Verification - Model verification)
   - Methodology appropriate (verification: Specification.md Verification sections)
   - Results reasonable (surge magnitudes consistent with Joukowsky equation) (verification: Specification.md Verification - Results validation; examples: Guidance.md Principles item 1)
   - Mitigation measures effective and feasible (verification: Specification.md Verification - Mitigation verification)
   - Conclusions supported by analysis (verification: Specification.md Verification - Acceptance)
3. Reviewer signs off or issues comments (quality: Specification.md QR-4; verification table)
...
|------|---------------------|---------------------|
| 1. Build Model | Geometry check, boundary condition review | Model matches drawings; fluid properties reasonable; loading arm data correct (requirements: Specification.md FR-2, FR-3, FR-4; quality: Specification.md QR-1; verification: Specification.md Verification - Model verification) |
| 2. Run Analysis | Software simulation | All scenarios analyzed (including ship disconnect); results generated (requirements: Specification.md FR-5, FR-6; verification: Specification.md Verification - Results validation) |
...
| 4. Develop Mitigation | Re-analysis with mitigation | Mitigation reduces surge to acceptable levels; loading arm valve closing times defined (requirements: Specification.md FR-9, FR-10; performance: Specification.md PR-1, PR-2; interface: Specification.md IR-6; verification: Specification.md Verification - Mitigation verification; cross-reference DEL-14.08) |
...
- All surge scenarios analyzed (including marine-specific ship disconnect) (requirements: Specification.md FR-5; verification table)
...
- Mitigation measures defined and implementable (requirements: Specification.md FR-10; verification table; cross-reference PKG-11, DEL-14.08)
...
- Marine loading system design (for loading arm ESD valve closing time requirements) (interface: Specification.md IR-6; cross-reference PKG-11, DEL-14.08)
- Valve procurement (for valve specifications and closing time requirements) (cross-reference PKG-16, DEL-14.08)
