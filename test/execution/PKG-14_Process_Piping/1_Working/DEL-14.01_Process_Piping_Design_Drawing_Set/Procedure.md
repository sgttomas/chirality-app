...
This procedure defines the process for producing and managing **Process Piping Design Drawing Set** within **PKG-14 Process Piping**.

Defines the design arrangement and details for process piping per ER requirements.
