...
This guidance document supports the development of **Lighting Design Calculations** for **PKG-18 Lighting**.

Provides the engineering basis and sizing/verification calculations for lighting.

This deliverable is classified as a **Calculation** under the **Electrical** discipline, to be produced by **D&B Contractor**.
