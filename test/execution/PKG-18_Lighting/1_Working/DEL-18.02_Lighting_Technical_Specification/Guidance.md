...
This guidance document supports the development of **Lighting Technical Specification** for **PKG-18 Lighting**.

Defines performance, materials, and workmanship requirements for lighting per ER requirements.

This deliverable is classified as a **Specification** under the **Electrical** discipline, to be produced by **D&B Contractor**.
