# Guidance: DEL-18.04 Lighting Data Sheet Package

## Purpose

This guidance document supports the development of **Lighting Data Sheet Package** for **PKG-18 Lighting**.

Defines and substantiates lighting in accordance with ER requirements.

This deliverable is classified as a **Data Sheet** under the **Electrical** discipline, to be produced by **D&B Contractor**.
