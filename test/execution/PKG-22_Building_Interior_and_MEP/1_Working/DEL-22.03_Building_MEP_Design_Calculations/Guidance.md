...
Provides the engineering basis and sizing/verification calculations for building mep.

This deliverable is classified as a **Calculation** under the **Buildings** discipline, to be produced by **D&B Contractor**.
