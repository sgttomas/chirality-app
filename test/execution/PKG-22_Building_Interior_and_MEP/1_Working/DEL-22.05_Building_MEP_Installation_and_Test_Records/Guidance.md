# Guidance: DEL-22.05 Building MEP Installation & Test Records

## Purpose

This guidance document supports the development of **Building MEP Installation & Test Records** for **PKG-22 Building Interior & MEP**.

Provides evidence of completion, inspection, and testing for building mep.

This deliverable is classified as a **Record** under the **Buildings** discipline, to be produced by **D&B Contractor (QA/QC)**.
