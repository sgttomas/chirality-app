...
This procedure defines the process for producing and managing **Marine Loading Design Calculations** within **PKG-11 Marine Loading System**.

Provides the engineering basis and sizing/verification calculations for marine loading.
