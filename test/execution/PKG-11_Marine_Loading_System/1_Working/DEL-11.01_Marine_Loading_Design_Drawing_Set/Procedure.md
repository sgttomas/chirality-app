...
This procedure defines the process for producing and managing **Marine Loading Design Drawing Set** within **PKG-11 Marine Loading System**.

Defines the design arrangement and details for marine loading per ER requirements.
