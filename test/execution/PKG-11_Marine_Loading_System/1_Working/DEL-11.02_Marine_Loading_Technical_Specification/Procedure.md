...
This procedure defines the process for producing and managing **Marine Loading Technical Specification** within **PKG-11 Marine Loading System**.

Defines performance, materials, and workmanship requirements for marine loading per ER requirements.
...
- Marine loading arm specification
- double-walled pipe specification
