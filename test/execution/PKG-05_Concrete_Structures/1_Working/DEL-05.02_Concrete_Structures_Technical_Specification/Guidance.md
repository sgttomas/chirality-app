...
This guidance document supports the development of **Concrete Structures Technical Specification** for **PKG-05 Concrete Structures**.

Defines performance, materials, and workmanship requirements for concrete structures per ER requirements.

This deliverable is classified as a **Specification** under the **Structural** discipline, to be produced by **D&B Contractor**.
