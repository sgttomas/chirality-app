...
This specification defines the requirements for **Pavement Design Calculations** within **PKG-04 Pavement & Surfacing**.

Provides the engineering basis and sizing/verification calculations for pavement.
