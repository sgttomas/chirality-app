# Procedure: DEL-33.08 Waterway Pollution Control Method Statement

## Purpose

This procedure defines the process for producing and managing **Waterway Pollution Control Method Statement** within **PKG-33 HSE Management**.
