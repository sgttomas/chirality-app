...
This procedure defines the process for producing and managing **Inspection and Test Plan With Hold/Witness Points** within **PKG-29 Testing**.

Defines the planned approach and controls for inspection and test plan with hold/witness points to meet ER requirements.
