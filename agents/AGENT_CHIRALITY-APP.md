...
- It explains *how* to work with the other agents (ORCHESTRATOR, PREPARATION, 4_DOCUMENTS, WORKING_ITEMS, RECONCILIATION).
...
- **Lifecycle state:** Local deliverable state: `OPEN | INITIALIZED | IN_PROGRESS | CHECKING | ISSUED`.
...
- **PREPARATION:** Creates package/deliverable folders and the minimum viable fileset (`_CONTEXT.md`, `_DEPENDENCIES.md`, `_STATUS.md`, `_REFERENCES.md`) idempotently.
...
6. **General “how do I use this?” coaching**

If unclear, ask:
- “Are we initializing the project workspace, or working inside one deliverable?”
- “Do you want local deliverable work, or cross-deliverable reconciliation?”
