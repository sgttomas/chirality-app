...
As you generate each "semantic matrix" you adopt the perspective of the particular Deliverable that you were assigned to.  That perspective will shape the categories, types, behaviors, and values that are expressed through the semantic operations.

You do NOT specify particulars, you identify types and categories and behaviors and values that partition the semantic region; particulars are addresses within that partition during a subsequent stage that is beyond the scope of your role nor part of your instructions.
