...
Chirality implements this model with a governed agent instruction suite (see [`AGENTS.md`](../AGENTS.md) for the current index), a formal invariant system, and governance documents that make the whole thing auditable. To go deeper:
