...
- Workspace root path (e.g., `{project_root}/execution/`)
...
- Create (if missing) a project-level folder: `execution/_Reconciliation/`
- Write a report file:
  - `execution/_Reconciliation/Reconciliation_Report_{GateLabel}_{YYYY-MM-DD}.md`
