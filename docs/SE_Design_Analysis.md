...
**K-* (System-wide invariants):** 23 named, stable invariants covering hierarchy, authority, sealing, dependencies, status, staleness, gates, merge, provenance, invention, conflicts, write scope, and snapshots. Defined in `CONTRACT.md` with enforcement points.
