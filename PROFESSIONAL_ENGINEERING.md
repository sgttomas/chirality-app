...
- Three layers of contracts govern agent behavior: R1–R9 workflow design requirements (defined in `agents/AGENT_HELPS_HUMANS.md`), I1–I10 decomposition invariants (defined in `agents/AGENT_DECOMP_BASE.md`), and 23 K-* system-wide invariants (defined in `docs/CONTRACT.md`).
...
| `docs/CONTRACT.md` | 23 binding invariants (K-*) with enforcement map |
