...
- **DECOMPOSITION_PATH:** `examples/execution-6a/_Decomposition/Penhold_PSB_Project_Decomposition_FINAL_v1.0_PHASE7.md` -- found and used for anchor validation and label resolution.
