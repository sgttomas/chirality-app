...
| Input | Resolved Path |
|---|---|
| RUN_ROOT | examples/execution-6a |
| ESTIMATES_ROOT | examples/execution-6a/_Estimates/ |
| DECOMPOSITION_PATH | examples/execution-6a/_Decomposition/Penhold_PSB_Project_Decomposition_FINAL_v1.0_PHASE7.md |
| DEPENDENCY_SOURCES | AUTO (resolved: PKG-005/.../DEL-05-06_.../Dependencies.csv -- 10 rows) |

## PRICE_SOURCES (resolved)

1. `examples/execution-6a/_PriceSources/Optional_Items_Pricing.csv` -- Appliance line items OPT-12 through OPT-17; labeled PARAMETRIC basis in source; treated as QUOTE per brief guidance (see Decision_Log.md DEC-EST-001).
2. `examples/execution-6a/_PriceSources/Assumed_Project_Parameters.csv` -- Project parameters reference (not used for pricing; quantities confirmed only).
