...
| Field | Value |
|---|---|
| Path | examples/execution-6a/_PriceSources/Professional_Staff_Rates.csv |
| Type | Rate Table |
...
| Field | Value |
|---|---|
| Path | examples/execution-6a/_PriceSources/Level_of_Effort.csv |
...
| Field | Value |
|---|---|
| Path | examples/execution-6a/_Decomposition/Penhold_PSB_Project_Decomposition_FINAL_v1.0_PHASE7.md |
...
| Field | Value |
|---|---|
| Path | examples/execution-6a/PKG-001_General Requirements & Delivery Controls/1_Working/DEL-01-01_Integrated Design Management & Submission Packages/Dependencies.csv |
