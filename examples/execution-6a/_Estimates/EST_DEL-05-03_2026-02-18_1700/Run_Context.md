...
|---|---|---|
| **RUN_ROOT** | `examples/execution-6a` | EXISTS |
| **ESTIMATES_ROOT** | `examples/execution-6a/_Estimates/` | EXISTS |
| **DECOMPOSITION_PATH** | `examples/execution-6a/_Decomposition/Penhold_PSB_Project_Decomposition_FINAL_v1.0_PHASE7.md` | LOADED |
