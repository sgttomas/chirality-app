...
- **Path:** examples/execution-6a/_PriceSources/Structural_Concrete_Rates.csv
...
- **Path:** examples/execution-6a/_PriceSources/Building_Envelope_Rates.csv
- **Source Type:** Rate Table
...
- **Path:** examples/execution-6a/_PriceSources/Interior_Architectural_Rates.csv
- **Source Type:** Rate Table
- **Items Used:** IA-08
...
- **Path:** examples/execution-6a/_PriceSources/Mechanical_System_Rates.csv
- **Source Type:** Rate Table
...
- **Path:** examples/execution-6a/_PriceSources/Electrical_System_Rates.csv
- **Source Type:** Rate Table
- **Items Used:** None
...
- **Path:** examples/execution-6a/_PriceSources/Equipment_Pricing.csv
...
- **Path:** examples/execution-6a/_PriceSources/Professional_Design_Fees.csv
...
- **Path:** examples/execution-6a/_PriceSources/Construction_Labour_Rates.csv
...
- **Path:** examples/execution-6a/_PriceSources/Assumed_Project_Parameters.csv
