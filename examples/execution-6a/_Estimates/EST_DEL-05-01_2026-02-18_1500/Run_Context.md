...
| **PRICE_SOURCES[0]** | examples/execution-6a/_PriceSources/Optional_Items_Pricing.csv |
| **PRICE_SOURCES[1]** | examples/execution-6a/_PriceSources/Assumed_Project_Parameters.csv |
