...
- **Coordination approach:** Dependencies coordinated externally by humans (see `_DEPENDENCIES.md` and `examples/execution-6/_Coordination/_COORDINATION.md`)
...
|-----------|----------|---------|
| **RFP 2024_004 (full document)** | `examples/execution-6/_Sources/` | Section 7.1.6 firm experience requirements, Appendix A (OSR) |
| **Addendum 03** | `examples/execution-6/_Sources/` | Scope clarifications affecting team/firm requirements |
| **Decomposition Document** | `examples/execution-6/_Decomposition/` | Deliverable definition, objectives, scope items, evaluation criteria |
