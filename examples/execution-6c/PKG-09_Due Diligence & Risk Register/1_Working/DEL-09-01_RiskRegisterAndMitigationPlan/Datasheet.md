...
4. **Decomposition Document** — `examples/execution-6/_Decomposition/Penhold_PSB_Project_Decomposition_Final_AddendumIntegrated_v1.md`
   - §1 Intake Summary
...
All reference materials listed in _REFERENCES.md are accessible at `examples/execution-6/_Sources/`:
