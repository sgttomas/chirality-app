...
**Source:** `examples/execution-6/PKG-04_Design Proposal (Concept + Design Brief)/1_Working/DEL-02-03_SustainabilityAndEnergyNarrative/_CONTEXT.md`
...
1. **Decomposition Document:**
   `examples/execution-6/_Decomposition/Penhold_PSB_Project_Decomposition_Final_AddendumIntegrated_v1.md`
...
2. **Context File:**
   `examples/execution-6/PKG-04_Design Proposal (Concept + Design Brief)/1_Working/DEL-02-03_SustainabilityAndEnergyNarrative/_CONTEXT.md`

3. **References File:**
   `examples/execution-6/PKG-04_Design Proposal (Concept + Design Brief)/1_Working/DEL-02-03_SustainabilityAndEnergyNarrative/_REFERENCES.md`
...
4. **RFP and Addenda (not directly accessible via Read tool):**
   - `examples/execution-6/_Sources/AB-2024-07156-Penhold Public Services Building RFP_2024_004.pdf`
   - `examples/execution-6/_Sources/AB-2024-07156-Penhold_Public Services Building Addendum01.pdf`
   - `examples/execution-6/_Sources/AB-2024-07156-Penhold_Public Services Building Addendum03.pdf`
