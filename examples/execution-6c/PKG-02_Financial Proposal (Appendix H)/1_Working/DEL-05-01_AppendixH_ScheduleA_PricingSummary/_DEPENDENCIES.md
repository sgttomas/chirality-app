...
- DELIVERABLE_PATH: `examples/execution-6c/PKG-02_Financial Proposal (Appendix H)/1_Working/DEL-05-01_AppendixH_ScheduleA_PricingSummary`
...
**_REFERENCES.md used:** Yes — used to resolve document pointer paths for TargetType=DOCUMENT rows (DEP-05-01-E-007, DEP-05-01-E-008). Sources directory: `examples/execution-6/_Sources/`.
