...
| Snapshot Folder | examples/execution-6c/_Estimates/EST_DEL-05-03_2026-02-18_1430 |
| DECOMPOSITION_PATH | examples/execution-6c/_Decomposition/Penhold_PSB_Project_Decomposition_Final_AddendumIntegrated_v1.md |
| Dependencies.csv | examples/execution-6c/PKG-02_Financial Proposal (Appendix H)/1_Working/DEL-05-03_PricingNarrativeAndAssumptions/Dependencies.csv |
| Professional_Staff_Rates.csv | examples/execution-6c/_PriceSources/Professional_Staff_Rates.csv |
| Level_of_Effort.csv | examples/execution-6c/_PriceSources/Level_of_Effort.csv |
| Assumed_Project_Parameters.csv | examples/execution-6c/_PriceSources/Assumed_Project_Parameters.csv |
