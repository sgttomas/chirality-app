...
| **RUN_ROOT** | examples/execution-6c/PKG-03_Team Qualifications (Appendix I + resumes)/1_Working/DEL-07-01_DesignBuildFirmExperienceProfile |
...
| **PRICE_SOURCES[0]** | examples/execution-6c/_PriceSources/Professional_Staff_Rates.csv |
| **PRICE_SOURCES[1]** | examples/execution-6c/_PriceSources/Level_of_Effort.csv |
| **PRICE_SOURCES[2]** | examples/execution-6c/_PriceSources/Assumed_Project_Parameters.csv |
