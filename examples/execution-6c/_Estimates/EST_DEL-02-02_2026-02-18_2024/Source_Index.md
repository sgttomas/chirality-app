...
| Field | Value |
|-------|-------|
| **Path** | examples/execution-6c/_PriceSources/Professional_Staff_Rates.csv |
...
| Field | Value |
|-------|-------|
| **Path** | examples/execution-6c/_PriceSources/Level_of_Effort.csv |
...
| Field | Value |
|-------|-------|
| **Path** | examples/execution-6c/_PriceSources/Assumed_Project_Parameters.csv |
...
| Field | Value |
|-------|-------|
| **Path** | examples/execution-6c/PKG-04_Design Proposal (Concept + Design Brief)/1_Working/DEL-02-02_DesignBriefNarrative/Dependencies.csv |
...
| Field | Value |
|-------|-------|
| **Path** | examples/execution-6c/PKG-04_Design Proposal (Concept + Design Brief)/1_Working/DEL-02-02_DesignBriefNarrative/_DEPENDENCIES.md |
...
| Field | Value |
|-------|-------|
| **Path** | examples/execution-6c/_Decomposition/Penhold_PSB_Project_Decomposition_Final_AddendumIntegrated_v1.md |
