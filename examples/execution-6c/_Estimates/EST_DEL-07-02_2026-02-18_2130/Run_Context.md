...
- **RUN_ROOT:** `examples/execution-6c/PKG-03_Team Qualifications (Appendix I + resumes)/1_Working/DEL-07-02_KeyTeamMembersAndResumes`
...
- **PRICE_SOURCES:**
  1. `examples/execution-6c/_PriceSources/Professional_Staff_Rates.csv`
  2. `examples/execution-6c/_PriceSources/Level_of_Effort.csv`
  3. `examples/execution-6c/_PriceSources/Assumed_Project_Parameters.csv`
