...
|-----------|-------|
| **SCOPE** | DEL-02-03 |
| **RUN_ROOT** | `examples/execution-6c/PKG-04_Design Proposal (Concept + Design Brief)/1_Working/DEL-02-03_SustainabilityAndEnergyNarrative` |
...
1. `examples/execution-6c/_PriceSources/Professional_Staff_Rates.csv` -- 30 roles with hourly rates (CAD)
2. `examples/execution-6c/_PriceSources/Level_of_Effort.csv` -- 65 rows; 4 rows applicable to DEL-02-03
3. `examples/execution-6c/_PriceSources/Assumed_Project_Parameters.csv` -- 29 parameters; used for scope calibration context

### DECOMPOSITION_PATH (resolved)

`examples/execution-6c/_Decomposition/Penhold_PSB_Project_Decomposition_Final_AddendumIntegrated_v1.md`
...
- `examples/execution-6c/PKG-04_Design Proposal (Concept + Design Brief)/1_Working/DEL-02-03_SustainabilityAndEnergyNarrative/Dependencies.csv` -- 11 rows (3 ANCHOR, 5 EXECUTION UPSTREAM, 3 EXECUTION DOWNSTREAM)
