...
|-----------|-------|
| SCOPE | DEL-06-01 |
| RUN_ROOT | examples/execution-6c |
...
|----------|---------------|
| Decomposition | examples/execution-6c/_Decomposition/Penhold_PSB_Project_Decomposition_Final_AddendumIntegrated_v1.md |
| Dependencies (AUTO) | examples/execution-6c/PKG-07_Commissioning, Closeout & Warranty/1_Working/DEL-06-01_CommissioningTrainingCloseoutWarrantyNarrative/Dependencies.csv |
| Staff Rates | examples/execution-6c/_PriceSources/Professional_Staff_Rates.csv |
| Level of Effort | examples/execution-6c/_PriceSources/Level_of_Effort.csv |
| Project Parameters | examples/execution-6c/_PriceSources/Assumed_Project_Parameters.csv |
