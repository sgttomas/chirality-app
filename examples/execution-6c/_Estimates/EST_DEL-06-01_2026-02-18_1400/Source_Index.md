...
| Source | Path | Usage |
|--------|------|-------|
| Dependencies.csv (DEL-06-01) | examples/execution-6c/PKG-07_Commissioning, Closeout & Warranty/1_Working/DEL-06-01_CommissioningTrainingCloseoutWarrantyNarrative/Dependencies.csv | Blocker/readiness assessment only; not used for pricing |
