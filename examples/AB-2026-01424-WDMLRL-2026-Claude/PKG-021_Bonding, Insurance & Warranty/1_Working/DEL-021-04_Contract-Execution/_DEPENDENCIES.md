...
- **DECOMPOSITION_PATH:** `<chirality-root>-project-test/test/AB-2026-01424-WDMLRL-2026-Claude/_Decomposition/WDMLRL_Decomposition_Claude.md` (found and loaded successfully)
