# QA Report — EST_DEL-005-07_2026-02-27_0547
...
| Check | Result |
|---|---|
| Snapshot folder exists: `EST_DEL-005-07_2026-02-27_0547/` | PASS |
...
| Allowance/parametric convention: milestone lines (DL-005 through DL-020) have Qty=1, Unit=LS, UnitRate=Amount=0 | PASS |
| Row count | 20 lines |
...
|---|---|
| Totals meaningful | YES — $9,960 CAD total from 70 labour hours across 4 roles |
| Critical input gaps | NONE — all LOE hours and rates are sourced |
| Material TBDs | N/A — design services deliverable, no materials |
| Assumptions remaining | 4 assumptions logged (see Assumptions_Log.md), all bounded |
| **RUN_STATUS** | **OK** |
...
| Check | Result |
|---|---|
| Deliverables in scope | 1 (DEL-005-07) |
| Documents read | 4 of 4 (Datasheet, Specification, Guidance, Procedure) — all present |
| Missing documents | 0 |
| Items extracted | 20 (4 priced labour lines + 16 activity/milestone markers) |
| Items with Qty = TBD | 0 |
...
| Items at $0 (milestones, effort included elsewhere) | 16 |
...
| Quantity takeoff (Items.csv) reviewed for completeness | PASS | 20 items extracted from 4 documents covering 17 specification requirements |
| Basis-consistency checks pass | PASS | PARAMETRIC throughout |
| Provenance completeness reported | PASS | 100% |
| Scope coverage explicit | PASS | 1 deliverable (DEL-005-07); exclusions documented in Summary.md |
...
1. **Construction value establishment.** Once a construction cost estimate is available, the fee-based cross-check (DF-05 @ 1.0% of construction value) can be completed to validate the LOE-derived total.
...
3. **P.Eng. hours separation.** If the P.Eng. of Record is a different person from the Civil Engineer (R-17), a separate line item and hours allocation should be added.
4. **Geotechnical revision hours.** If DEL-008-01 (geotechnical report) data requires revisions to the civil specification, additional revision hours should be estimated and added as a separate line item or revision to ITM-004.
