# Run Context — EST_DEL-017-02_2026-02-27_0532

| Field | Value |
|-------|-------|
| **RunID** | EST_DEL-017-02_2026-02-27_0532 |
| **AsOf** | 2026-02-27T05:32Z |
| **Scope** | DEL-017-02 (Mezzanine Reno) |
...
| Deliverable Folder | PKG-017_Existing Building Renovation (Old North Shop)/1_Working/DEL-017-02_Mezzanine-Reno |
...
- Mezzanine footprint (area in m2/sqft) is TBD per Datasheet; quantities for area-based items are estimated using parametric assumptions (see Assumptions_Log.md, ASM-001).
- Structural condition is unknown; structural repair scope is a parametric allowance.
- Electrical, flooring, finishes, and stair/railing scope details are design-gated; priced as parametric estimates.
