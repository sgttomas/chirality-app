...
| **Limitations** | Hours are parametric estimates for a drawing set deliverable; not validated against actual project complexity. Low-voltage scope is narrow (2 confirmed systems) but significant TBDs exist. |
