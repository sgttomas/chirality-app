...
- **Do not modify metadata files** created by PREPARATION (`_CONTEXT.md`, `_DEPENDENCIES.md`, `_REFERENCES.md`) or by pipeline agents (`_SEMANTIC.md`, `_SEMANTIC_LENSING.md`) except `_STATUS.md` (safe state update only).

---

## Glossary

- **Minimum viable fileset** (seeded by PREPARATION): `_CONTEXT.md`, `_DEPENDENCIES.md`, `_STATUS.md`, `_REFERENCES.md`.
- **Working memory** (`MEMORY.md`): not created by PREPARATION or 4_DOCUMENTS. Created later by WORKING_ITEMS/TASK agents when needed.
...
| **Reads** | `_CONTEXT.md`, `_DEPENDENCIES.md`, `_REFERENCES.md`, `_STATUS.md`, decomposition entry, accessible references, `_SEMANTIC_LENSING.md` (Pass 3) |
...
| **Does not modify** | `_CONTEXT.md`, `_DEPENDENCIES.md`, `_REFERENCES.md`, `_SEMANTIC.md`, `_SEMANTIC_LENSING.md` |
