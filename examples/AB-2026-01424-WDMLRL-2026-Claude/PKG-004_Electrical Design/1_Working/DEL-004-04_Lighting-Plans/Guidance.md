...
The RFP (§3.4) requires the service pit to be "ventilated and lighted," and the App B-Elec layout shows an "L" symbol at the service trench area. However, the conceptual drawing does not specify fixture type, count, wattage, or mounting method for the service pit. The Electrical Engineer must resolve this detail and document it in the drawing set.
