...
| B:data:sufficiency | data | sufficiency | adequate evidence | 1 | HAS_ITEMS | Service trench dimension sourcing |
...
| B-002 | B:data:sufficiency | Conflict | Multi | Guidance | Resolve service trench dimensions: R-04 shows "24'" and "100'" annotations near the SERVICE TRENCH label; Guidance notes 100 ft may refer to building depth not trench length | Service trench width (24 ft) and length are used in Datasheet and Specification but CONF-FP-02 in Guidance flags that the 100 ft dimension may be building depth, not trench length; this data insufficiency propagates into framing design | Datasheet.md; Guidance.md | Datasheet ## Attributes — Service trench; Guidance ## Conflict Table — CONF-FP-02 | Datasheet.md#Attributes (24 ft x 100 ft); Guidance.md#Conflict-Table (100 ft may be building depth) | County / Architect confirmation from R-04 | TBD |
