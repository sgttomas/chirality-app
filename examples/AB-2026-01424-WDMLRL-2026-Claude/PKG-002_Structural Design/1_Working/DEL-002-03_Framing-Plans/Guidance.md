...
The conceptual floor plan (R-04, Appendix B) shows the spatial layout of all rooms, the service trench, the wash bay, the parts room, and the mezzanine. The structural column grid must be developed in coordination with the architectural floor plan (DEL-001-02) to avoid columns conflicting with the wash bay, service trench, repair bay drive-through paths, and crane envelopes. Column placement in drive-through repair bays and the crane aisle is heavily constrained.
...
The RFP specifies a "concrete structure" (R-01, §3.4; R-04). This likely indicates concrete columns and/or concrete walls, potentially combined with steel framing for the roof and mezzanine. The exact combination (precast concrete, cast-in-place concrete, steel frame with concrete encasement, or hybrid) is a design decision for the Structural Engineer. The framing plans must clearly indicate the material of each element. **ASSUMPTION:** The structural system will be a concrete or hybrid concrete-steel industrial frame; pure wood-frame construction is not appropriate for a 35 ft clear height industrial building with overhead cranes.

### Crane Runway Coordination
The conceptual plan (R-04) shows two 5-ton crane runways running the length of the main shop (north-south, approximately 100 ft span). The Structural Engineer must:
- Confirm the crane runway clear span with the crane supplier.
- Coordinate the runway beam bottom-of-steel elevation with the 35 ft clear height requirement.
- Design runway beam end stops and runway beam connections.
- Ensure the runway framing is shown on DEL-002-03 and detailed on DEL-002-07.

### Service Pit / Trench
The service pit/trench is approximately 24 ft × 100 ft per the conceptual plan (R-04 — ASSUMPTION based on plan notation). The below-grade walls of the pit are structural and must be designed for soil pressure and vehicle surcharge loads. The framing plan should show the pit extents, the header framing at the pit opening at floor level, and any structural cover framing. Details belong in DEL-002-06.
...
|---|---|---|
| Concrete vs. steel framing | Concrete is specified by RFP (R-01, §3.4: "Concrete structure"). Concrete provides fire resistance and mass but may be slower to construct. A hybrid system (concrete columns, steel roof and mezzanine framing) is common for industrial buildings. **Decision criteria for hybrid system evaluation:** (1) **Cost:** Hybrid systems often reduce material and forming costs for long-span roof members compared to cast-in-place concrete beams. (2) **Schedule:** Steel roof framing can be erected faster than cast-in-place concrete at height, potentially compressing the construction schedule toward the December 2026 deadline. (3) **Fire rating:** NBC fire resistance requirements depend on occupancy classification (TBD per REQ-FP-21); if Group F Division 3, fire resistance requirements for industrial buildings may permit unprotected steel in the roof. (4) **Crane load path:** The crane runway structure must transfer dynamic crane loads (vertical, horizontal, impact) to foundations; concrete columns provide superior stiffness for crane load paths compared to steel columns. The Structural Engineer should document this evaluation and obtain explicit County acceptance of any departure from the RFP "concrete structure" language before proceeding with hybrid design. (Lensing ref: F-003) | ASSUMPTION: Structural Engineer to evaluate hybrid system with documented decision criteria; any departure from "concrete structure" must be confirmed acceptable to the County. |
...
| CONF-FP-02 | Service trench dimensions: R-04 shows a "SERVICE TRENCH" annotation with "24'" and "100'" markings, but the 100 ft dimension may refer to the building depth rather than the trench length. **Impact (Lensing ref: B-002):** Service trench width (24 ft) and length propagate into framing design (pit header framing, floor slab openings). The 100 ft dimension is ambiguous — if it refers to building depth rather than trench length, the trench framing and Datasheet service trench attributes are incorrect. Resolution required before framing plan production at the pit/trench area. | R-04, Appendix B (SERVICE TRENCH annotation) | R-04 overall building dimension annotation (100 ft building depth) | Datasheet (service trench dimensions), Specification (REQ-FP-08), Procedure (Step 3) | The 24 ft width annotation is likely the service trench width; the 100 ft likely refers to the building depth. Actual trench length is TBD and must be confirmed by the Structural Engineer from the architectural plans (DEL-001-02) or confirmed with County/Architect from R-04. | TBD |
