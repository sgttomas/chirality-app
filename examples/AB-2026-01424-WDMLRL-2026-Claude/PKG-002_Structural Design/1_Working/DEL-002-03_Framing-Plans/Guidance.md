...
| CONF-FP-02 | Service trench dimensions: R-04 shows a "SERVICE TRENCH" annotation with "24'" and "100'" markings, but the 100 ft dimension may refer to the building depth rather than the trench length. **Impact (Lensing ref: B-002):** Service trench width (24 ft) and length propagate into framing design (pit header framing, floor slab openings). The 100 ft dimension is ambiguous — if it refers to building depth rather than trench length, the trench framing and Datasheet service pit attributes are incorrect. Resolution required before framing plan production at the pit/trench area. | R-04, Appendix B (SERVICE TRENCH annotation) | R-04 overall building dimension annotation (100 ft building depth) | Datasheet (service pit dimensions), Specification (REQ-FP-08), Procedure (Step 3) | The 24 ft width annotation is likely the service pit width; the 100 ft likely refers to the building depth. Actual trench length is TBD and must be confirmed by the Structural Engineer from the architectural plans (DEL-001-02) or confirmed with County/Architect from R-04. | TBD |
