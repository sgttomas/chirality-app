...
|---|---|---|---|---|---|---|
| CON-001 | Pit dimensions: App B labels "24'" width and "100'" length on the Service Trench, but it is unclear whether these are exterior wall dimensions, interior clear dimensions, or approximate. The Structural Engineer must confirm which dimension is the design target (interior clear or overall). | App B (Shop) floor plan — labeled 24' and 100' on Service Trench | RFP §3.4 — no dimension stated | Datasheet (Attributes), Specification (R-003), Procedure (Step 3) | PROPOSAL: treat App B dimensions as interior clear dimensions (i.e., usable pit width = 24', usable pit length = 100') until confirmed by Owner/Architect | TBD |
