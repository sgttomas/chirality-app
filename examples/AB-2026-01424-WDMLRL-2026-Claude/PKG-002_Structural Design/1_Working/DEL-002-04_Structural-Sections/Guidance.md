...
| CON-002 | Service pit depth is not stated in RFP or App B. App B labels it "Service Pit" with width/length annotations but no depth. | R-04 App B (width 24 ft, length 100 ft annotated) | R-01 §3.4 (ventilated and lighted; no depth) | Specification.md R-005; Datasheet.md Attributes; Procedure.md Step 7 | Structural Engineer to determine functional depth with Owner/operations team; depth drives soil retention, concrete volume, and waterproofing scope | TBD |
