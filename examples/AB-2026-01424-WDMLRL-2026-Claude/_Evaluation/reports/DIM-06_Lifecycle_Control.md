...
File: `<legacy-chirality-app-test>/examples/AB-2026-01424-WDMLRL-2026-Claude/_Coordination/_COORDINATION.md`
...
| File | Purpose |
|------|---------|
| `<legacy-chirality-app-test>/docs/TYPES.md` | Canonical lifecycle state enum (Section 5.1) and coordination representations (Section 6) |
| `<legacy-chirality-app-test>/examples/AB-2026-01424-WDMLRL-2026-Claude/_Coordination/_COORDINATION.md` | Coordination representation declaration |
