...
| E-002 | E:reviewing:information | Normalization | Multi | Guidance | Normalize terminology for the below-grade element: "service pit" vs. "service trench" vs. "service pit/trench" used interchangeably across documents | Integrated inspection narrative: an inspection or review would need a single consistent term for the below-grade service element. Specification uses "service pit/trench" (REQ-012), Datasheet uses "Service trench / pit", Guidance uses "service pit/trench", and Procedure uses both forms. Establishing one primary term with the alternative as a parenthetical would improve cross-document traceability. | Specification.md; Datasheet.md; Guidance.md; Procedure.md | Specification.md#REQ-012; Datasheet.md#Spatial Program; Guidance.md#C-3; Procedure.md#Step 3.5 | -- | PROPOSAL: Guidance.md vocabulary note | TBD |
