...
| E-003 | E:judging:data | Normalization | Multi | Guidance | Normalize terminology: "Service Pit" vs "service pit" -- Datasheet uses "Service Pit / pit" while Specification and Procedure use "service pit." Establish a single term and define it | Binding verdict evidence lens reveals inconsistent terminology for the below-grade service access feature. Datasheet says "Service Pit / pit" with dimensions "~24 ft x 100 ft per plan." Specification REQ-003 says "ventilated/lighted service pit." Procedure says "service pit" and "Service Pit/pit." Inconsistent naming risks confusion in the preliminary presentation. | Datasheet.md, Specification.md, Procedure.md | Datasheet#Building Program (Service Pit / pit), Specification#REQ-003, Procedure#Step 2.1, Step 3.1 | -- | PROPOSAL: Guidance (vocabulary note) and normalize across all docs | TBD |
