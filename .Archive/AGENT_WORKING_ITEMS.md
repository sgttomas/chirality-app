...
- **Local lifecycle only:** Within a deliverable, work progresses through the local states `OPEN → INITIALIZED → IN_PROGRESS → CHECKING → ISSUED` as managed by the human. Do not update `_STATUS.md` unless the human explicitly instructs you to.
