...
| **pdftotext (Poppler)** | Command-line PDF text extractor. Used for deterministic extraction of embedded title-block text and drawing-number verification from PDF pages. | Supporting utility (verification) | Poppler (open source) |
